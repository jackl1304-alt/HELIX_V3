  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card className="border-l-4 border-l-blue-500 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-blue-600 font-medium mt-1">
                +4.5% {t('analytics.vsLastMonth')}
              </p>
              <div className="flex items-center mt-2">
                <div className="h-2 w-2 rounded-full bg-blue-500 mr-2"></div>
                <span className="text-xs text-gray-500">{t('analytics.liveUpdates')}</span>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="border-l-4 border-l-green-500 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-600 font-medium mt-1">
                +8.1% {t('analytics.vsLastMonth')}
              </p>
              <div className="flex items-center mt-2">
                <div className="h-2 w-2 rounded-full bg-green-500 mr-2"></div>
                <span className="text-xs text-gray-500">{t('analytics.trendRising')}</span>
              </div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/zulassungen/global">
          <Card className="border-l-4 border-l-purple-500 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-200">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-600">
                {t('analytics.worldwideApprovals')}
              </CardTitle>
            ...
            <CardContent>
              ...
              <p className="text-xs text-purple-600 font-medium mt-1">
                {t('analytics.activeSourcesActive')}
              </p>
              <div className="flex items-center mt-2">
                <div className="h-2 w-2 rounded-full bg-purple-500 mr-2"></div>
                <span className="text-xs text-gray-500">{t('analytics.globallyAvailable')}</span>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="border-l-4 border-l-orange-500 cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-orange-600 font-medium mt-1">
                {t('analytics.dataSourcesActive')}
              </p>
              <div className="flex items-center mt-2">
                <div className="h-2 w-2 rounded-full bg-orange-500 mr-2"></div>
                <span className="text-xs text-gray-500">{t('analytics.realtimeSync')}</span>
              </div>
            </CardContent>
          </Card>
        </Link>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg font-semibold">{t('analytics.regionalDistribution')}</CardTitle>
            <CardDescription>{t('analytics.updatesByRegion')}</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="w-full">
                <div className="flex items-end justify-center space-x-8 h-40">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs mt-2">{t('analytics.europe')}</span>
                    <span className="text-xs text-gray-500">24</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-16 bg-blue-400 rounded-t" style={{height: '90px'}}></div>
                    <span className="text-xs mt-2">{t('analytics.northAmerica')}</span>
                    <span className="text-xs text-gray-500">18</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-16 bg-blue-300 rounded-t" style={{height: '60px'}}></div>
                    <span className="text-xs mt-2">{t('analytics.asiaPacific')}</span>
                    <span className="text-xs text-gray-500">12</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-16 bg-blue-200 rounded-t" style={{height: '40px'}}></div>
                    <span className="text-xs mt-2">{t('analytics.germany')}</span>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg font-semibold">{t('analytics.categoryBreakdown')}</CardTitle>
            <CardDescription>{t('analytics.distributionByDataType')}</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64 flex items-center justify-center">
              ...
              <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-4 rounded-full bg-white flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500">{t('analytics.coverage')}</div>
                  </div>
                </div>
                <div className="absolute -right-8 top-8 text-xs">
                  <div className="flex items-center mb-2">
                    <div className="w-3 h-3 bg-blue-500 rounded mr-2"></div>
                    <span>{t('analytics.regulatoryUpdatesLabel')}: 66</span>
                  </div>
                  <div className="flex items-center mb-2">
                    <div className="w-3 h-3 bg-green-500 rounded mr-2"></div>
                    <span>{t('analytics.legalCases')}: 65</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-3 h-3 bg-yellow-500 rounded mr-2"></div>
                    <span>{t('analytics.knowledgeArticles')}: 131</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">{t('analytics.thirtyDayTrend')}</CardTitle>
          <CardDescription>{t('analytics.updatesAndApprovalsOverTime')}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-64">
