...
export default function CustomerAIInsights() {
  ...
  const { data: insights, isLoading: isInsightsLoading, error: insightsError } = useQuery({
    ...
    enabled: mounted && tenantData?.customerPermissions?.analyticsInsights,
    retry: 1
  });
  ...
  const mockInsights: AIInsight[] = [
    {
      ...
      content: "Datenbasierte Auswertung zeigt eine 47% Zunahme der FDA-Aktivitäten im Bereich Herzschrittmacher in den letzten 30 Tagen. Dies deutet auf mögliche neue Regulierungen hin.",
    ...
    },
    {
      ...
      content: "Regulatorische Trendanalyse identifiziert wahrscheinliche neue MDR-Anforderungen für Klasse III Geräte basierend auf aktuellen Rechtsprechungsmustern.",
    ...
    },
    {
      ...
      content: "Datengetriebene Auswertung der Zulassungsdaten zeigt optimale Markteintrittschancen für innovative Diagnostikgeräte in Vietnam und Thailand.",
        ...
        <div className="container mx-auto p-6 space-y-8 max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div>
              ...
              <p className={`text-lg ${colors.textSecondary}`}>
                Datengetriebene Analysen und Vorhersagen für Ihr Unternehmen
              </p>
            </div>
            ...
            <Card className={`${colors.cardBg} border-red-200`}>
              <CardHeader>
                <CardTitle className="text-red-600 flex items-center gap-2">
                  ...
                  Fehler beim Laden der Insights
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Die Insights konnten nicht geladen werden. Bitte versuchen Sie es später erneut.
                </p>
              </CardContent>
            </Card>
          )}
            ...
            <Card className={`${colors.cardBg}`}>
              ...
              <CardContent>
                <p className={`${colors.textSecondary}`}>
                  Derzeit sind keine Insights verfügbar. Das System analysiert kontinuierlich neue Daten.
                </p>
              </CardContent>
            </Card>
          )}
          ...
          <Card className={colors.cardBg}>
            <CardHeader>
              ...
              <CardDescription className={colors.textSecondary}>
                Basierend auf datengetriebener Analyse generierte Handlungsempfehlungen
              </CardDescription>
            </CardHeader>
            <CardContent>
